...
// Arrow Functions: Multi-expression Syntax
let myArrowFunc = (param1, param2) => {
  console.log(param1)
  console.log(param2)
}

myArrowFunc("My nice short hand", "Arrow Function");

// Arrow Functions: Short
myArrowFunc = (param1) => console.log(param1);
myArrowFunc("Boo");
